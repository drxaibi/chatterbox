...
$lineWidth = 40
$title = 'STANDARD TTS'
$subtitle = 'Balanced quality and expressive control.'
...
$helperScriptPath = Join-Path ([System.IO.Path]::GetTempPath()) ("chatterbox-start-standard-{0}.ps1" -f ([guid]::NewGuid().ToString('N')))
